...
Search the Red Hat Container Catalog to find the answers.

1. What is the size of the UBI 8 micro container?
2. What is the podman or docker command to pull the ubi 8 micro image?
3. What is the health rating of ubi8/python-27 label 2.7-125?

Submit these answers to the instructors via the form provided.
