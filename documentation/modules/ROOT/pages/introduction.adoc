...
To enable cockpit you simply enable it as a service then open the local browser to localhost:9090, and log in as your (non-root) user by providing the username and password.
[.console-input]
[source,bash,subs="+macros,+attributes"]
----
