...
+ 
. Having looked at the contents of `visitor_info.txt` let's delete our copy from off the host by right-clicking on it in the Explorer and selecting `Delete Permanently`
+
image::delete-permanently.png[]
