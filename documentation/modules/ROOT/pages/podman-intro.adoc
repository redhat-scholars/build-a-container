...
+
{zwsp} +
. Next, let's use the VS Code editor to see what our command found out. Use the following to load the file in the editor. If this doesnt work use the steps below to open.
+
[.console-input]
[source,bash,subs="+macros,+attributes"]
----
