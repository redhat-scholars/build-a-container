...
. Open the `command pallete` by using kbd:[ctrl+shift+p] (or kbd:[CMD+shift+p] on a Mac)
. Start typing `browser` in the dialog box and then select the `Browser Preview: Open in Browser Preview`
+
