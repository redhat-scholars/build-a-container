...
We're going to use a tool called link:https://www.metasploit.com/[metasploit] (which has already been installed on your VM instance) to exploit the vulnerability (with frightening ease).  
