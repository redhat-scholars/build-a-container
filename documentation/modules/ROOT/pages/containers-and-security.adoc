...
. When it's done initializing, you should see output something like this (ASCII art will vary)
+
[.console-output]
[source,bash,subs="+macros,+attributes"]
----
...
=== Compliance Scanning with `oscap-podman`

[WARNING]
====
This section is unfinished and likely to be cut from the final workshop
====
